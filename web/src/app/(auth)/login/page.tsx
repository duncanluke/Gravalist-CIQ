...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen bg-[#101622] flex items-center justify-center p-6 bg-[radial-gradient(circle_at_top,_var(--tw-gradient-stops))] from-primary/10 via-transparent to-transparent text-slate-300">
            <div className="max-w-md w-full">
                ...
                <form onSubmit={handleLogin} className="bg-[#161e2e]/50 backdrop-blur-xl border border-white/5 rounded-2xl p-8 shadow-2xl space-y-6">
                    {message && (
